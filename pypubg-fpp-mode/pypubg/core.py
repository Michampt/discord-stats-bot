...
GAME_MODES = ['solo', 'duo', 'squad', 'solo-fpp', 'duo-fpp', 'squad-fpp']
GAME_REGIONS = ['as', 'na', 'agg', 'sea', 'eu', 'oc', 'sa']
...
class PUBGAPI:
    ...
    def player_mode_stats(self, player_handle, game_mode=GAME_MODES, game_region=GAME_REGIONS):
        ...
        if game_mode not in GAME_MODES:
            raise APIException("game_mode must be one of: solo, duo, squad, solo-fpp, duo-fpp, squad-fpp")
        if game_region not in GAME_REGIONS:
